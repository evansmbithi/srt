      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-xl-10 ftco-animate mb-5 pb-5" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span>Why park your car yet</span><br>WE PAY?</h1>
            <!--
...
-->
    <section class="ftco-section bg-light">
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <span class="subheading">Recently Suggested Vehicles</span>
            <h2 class="mb-4"><span>Recent</span> Posts</h2>
          </div>
        </div>
<!--
        <div class="row">
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-4"><span><img style="width:70px; margin-bottom:15px" src="<?php echo web_root; ?>plugins/jobportal/images/nai.png" alt="Nairobi county logo"></span><br>Hon. Mike Sonko</h2>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                ...
                <img style="margin-top:-75px" src="<?php echo web_root; ?>plugins/jobportal/images/win.jpg" alt="">
                  ...
                  <div class="text">
                    <p class="mb-4">The Sonko Rescue Team was  recognized and awarded for it's continuous voluntary work and for stepping in during the COVID-19 pandemic period.</p>
