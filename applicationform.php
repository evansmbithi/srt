...
<section class="ftco-section contact-section bg-light">
      <div class="container">
        ...
        <form class="form-horizontal span6  wow fadeInDown" action="insert.php"  enctype="multipart/form-data"  method="POST" autocomplete="off">

               <?php require_once('applicantform.php') ?>  

            </form>
        <!-- <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">  <!--right panel --
              <form class="form-horizontal span6  wow fadeInDown" action="process.php?action=submitapplication&JOBID=<?php echo $result->JOBID; ?>"  enctype="multipart/form-data"  method="POST" autocomplete="off">
          ...
          <div class="col-md-6 d-flex"> <!--left panel -->
                    <div class="panel">
