 ...
 <!-- <section class="ftco-about d-md-flex">
        ...
        <div class="heading-section ftco-animate ">
          <h2 class="mb-4"><span>Why park your car yet we pay?</span></h2>
        </div>
        <div>
...
<br> -->
    ...
    <div class="one-half ftco-animate">
    	...
    	<div class="one-half img" style="background-image: url(<?php echo web_root; ?>plugins/jobportal/images/Sonko-II-1.jpg);"></div>
